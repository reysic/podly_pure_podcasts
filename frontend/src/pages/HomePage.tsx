      ...
      {feedNotFound && (
        <div className="hidden lg:flex flex-[2] items-center justify-center bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
          <div className="text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">Feed not found</h3>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Pick a feed from the list to continue.</p>
          </div>
        </div>
      )}

                ...
                <>
                    ...
                    <div className="space-y-6">
                      <div className="bg-gray-50 dark:bg-gray-750 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          ...
                          <div className="text-left">
                            ...
                            <span className="ml-2 px-2 py-0.5 rounded text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300">
                              LLM Transcription
                            </span>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-lg p-4 text-center">
                            ...
                            <div className="text-sm text-blue-800 dark:text-blue-300">Transcript Segments</div>
                          </div>
                          ...
                          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900 dark:to-green-800 rounded-lg p-4 text-center">
                            ...
                            <div className="text-sm text-green-800 dark:text-green-300">Content Segments</div>
                          </div>

                          <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900 dark:to-red-800 rounded-lg p-4 text-center">
                            <div className="text-2xl font-bold text-red-600 dark:text-red-400">
                              {stats.processing_stats?.ad_segments_count || 0}
                            </div>
                            <div className="text-sm text-red-800 dark:text-red-300">Ad Segments Removed</div>
                          </div>
                        </div>
                      </div>
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="bg-gray-50 dark:bg-gray-750 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4 text-left">Advertisement Removal Summary</h3>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                              <div>
                                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{adBlocks.length}</div>
                                <div className="text-sm text-gray-600 dark:text-gray-400">Ad Blocks</div>
                              </div>
                              <div>
                                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{formatDuration(adTimeSeconds)}</div>
                                <div className="text-sm text-gray-600 dark:text-gray-400">Time Removed</div>
                              </div>
                              <div>
                                <div className="text-2xl font-bold text-rose-600 dark:text-rose-400">{adPercent.toFixed(1)}%</div>
                                <div className="text-sm text-gray-600 dark:text-gray-400">Episode Reduced</div>
                              </div>
                            </div>
                            ...
                            <div className="mt-5 space-y-3">
                              <div className="flex flex-wrap items-center justify-between gap-2 text-sm text-gray-600 dark:text-gray-400">
                                <div className="flex items-center gap-2">
                                  <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-white dark:bg-gray-700 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-600">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="bg-white dark:bg-gray-750 border dark:border-gray-600 rounded-lg p-4">
                              ...
                              {Object.entries(stats.processing_stats?.model_call_statuses || {}).map(([status, count]) => (
                                <div key={status} className="flex justify-between items-center">
                                  ...
                                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                                    status === 'success' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300' :
                                    status === 'failed' ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300' :
                  ...
                  {activeTab === 'model-calls' && (
                    <div>
                      ...
                      <div className="bg-white dark:bg-gray-750 border dark:border-gray-600 rounded-lg overflow-hidden">
                                  ...
                                  <tr key={call.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td className="px-4 py-3">
                                      <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${
                                        call.status === 'success' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300' :
                                        call.status === 'failed' ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300' :
